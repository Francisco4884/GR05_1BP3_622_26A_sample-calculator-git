...
public class CalculatorParametersTest {
    ...
    // El constructor recibe los parámetros de cada fila de la lista
    ...
    // Definición del conjunto de datos para la prueba
    ...
    public void given_parameters_when_addition_then_summation() {
        // Se asume que existe una clase llamada Calculator con un método addition
